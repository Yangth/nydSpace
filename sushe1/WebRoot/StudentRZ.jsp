        ...
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form id="fm" method="post" novalidate style="padding-top:100px">
              <label>选择楼宇：</label>
              <input id="build" class="easyui-combobox" url="" data-options="panelHeight:'auto'"><br><br>
              <label>选择宿舍：</label>
              <input id="domitory" name="Domitory_ID" class="easyui-combobox" url="" data-options="panelHeight:'auto'"><br><br>
			  <label>输入学号：</label>
			  <input id="username" name="username" style="line-height:16px;border:1px solid #ccc"><br><br>
