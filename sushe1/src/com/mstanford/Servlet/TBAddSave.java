...
public class TBAddSave extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
				...
				String TB_TeacherID=request.getParameter("Teacher_ID");
				String TB_BuildingID=request.getParameter("addbuilding_id");
				System.out.print("获取的id为="+TB_TeacherID+TB_BuildingID);
		   ...
		   if(isInvalid(TB_TeacherID)){
				...
				jsonb.addProperty("message", "请选择管理员！");
				...
				if(list.size()>0)
				{
					out.print("<script language='javascript'>alert('该管理员已经在管理本楼宇了，不要重复添加！');</script>");
					out.flush();out.close();
					return;
				}
