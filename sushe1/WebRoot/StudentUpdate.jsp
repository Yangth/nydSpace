        ...
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <form name="form1" method="post" action="StudentUpdateSave" target="TopFram" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="33%" height="30" align="right">&nbsp;</td>
                    <td width="67%"><input name="Student_ID" type="text" class="noshow" id="Student_ID" value="<%=cnbean.getStudent_ID() %>"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>学号：</td>
                    <td><input name="Student_Username" type="text" class="text2" id="Student_Username" value="<%=cnbean.getStudent_Username() %>"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="Student_Name" type="text" class="text2" id="Student_Name" value="<%=cnbean.getStudent_Name() %>"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="Student_Class" type="text" class="text2" id="Student_Class" value="<%=cnbean.getStudent_Class() %>"></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
