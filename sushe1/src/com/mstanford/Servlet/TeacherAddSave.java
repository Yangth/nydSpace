...
public class TeacherAddSave extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public TeacherAddSave() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(session.getAttribute("id")==null){
			out.print("<script language='javascript'>alert('亲重新登录！');top.location='Login.jsp';</script>");
			out.flush();out.close();
		}
		...
		if(list.size()>0)
		{
			out.print("<script language='javascript'>alert('编号不存在！');history.back(-1);</script>");
			out.flush();out.close();
		}
