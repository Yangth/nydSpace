...
public class AdminLogList extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			HttpSession session =request.getSession();
		     ...
		     //权限验证
				...
				{
					strWhere+=" and Log_StudentID='"+Student_Username+"'";
				}
				//查询数据
				 List<LogBean> list=new LogDao().GetList(strWhere,"Log_Date desc");
				 request.setAttribute("list", list);
				 request.getRequestDispatcher("AdminLogList.jsp").forward(request, response);
	}
