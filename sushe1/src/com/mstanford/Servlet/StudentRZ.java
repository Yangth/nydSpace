...
public class StudentRZ extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		 ...
		 List<DomitoryBean> domitorylist;
			...
			String BuildingID=request.getParameter("province");
			
			System.out.print("获取的buldngid="+BuildingID);
...
//				System.out.println(BuildingID);
				...
				}else if(flag.equals("domitory")){
					out.write(new Gson().toJson(domitorylist));
				}
	}
